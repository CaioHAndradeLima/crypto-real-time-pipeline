...
SNOWFLAKE_WAREHOUSE="${SNOWFLAKE_WAREHOUSE:-TRADING_WH}"
SNOWFLAKE_DATABASE="${SNOWFLAKE_DATABASE:-TRADING_ANALYTICS}"
SNOWFLAKE_ROLE="${SNOWFLAKE_ROLE:-ACCOUNTADMIN}"
SNOWFLAKE_SCHEMA="${SNOWFLAKE_SCHEMA:-BRONZE}"
SNOWFLAKE_TRADES_RAW_TABLE="${SNOWFLAKE_TRADES_RAW_TABLE:-TRADES_RAW}"
