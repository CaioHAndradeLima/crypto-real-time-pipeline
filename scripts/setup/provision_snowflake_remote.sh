...
export TF_VAR_snowflake_bootstrap_warehouse="${SNOWFLAKE_TERRAFORM_WAREHOUSE:-COMPUTE_WH}"
...
import_if_exists snowflake_warehouse.trading_wh TRADING_WH
import_if_exists snowflake_database.trading_analytics TRADING_ANALYTICS
import_if_exists snowflake_schema.bronze "TRADING_ANALYTICS.BRONZE"
import_if_exists snowflake_schema.silver "TRADING_ANALYTICS.SILVER"
import_if_exists snowflake_schema.gold "TRADING_ANALYTICS.GOLD"
